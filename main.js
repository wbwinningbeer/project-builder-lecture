...
async function predict(imgElement) {
    ...
    resultLabel.textContent = `Analysis Result: You resemble a ${topResult.className}!`;
    ...
    for (let i = 0; i < maxPredictions; i++) {
        ...
        const barHtml = `
            <div class="bar-container">
                <span style="width: 80px; text-align: left; font-weight: 500;">${classPrediction.className}</span>
                <div class="bar-bg">
                    <div class="bar-fill" style="width: ${percentage}%"></div>
                </div>
                <span style="width: 40px; font-weight: bold;">${percentage}%</span>
            </div>
        `;
